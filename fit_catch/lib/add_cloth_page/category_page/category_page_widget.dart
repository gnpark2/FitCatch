                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: StreamBuilder<List<ClothRecord>>(
                                stream: queryClothRecord(
                                  queryBuilder: (clothRecord) => clothRecord
                                      .where(
                                        'category',
                                        isEqualTo: widget!.categoryParam,
                                      )
                                      .where(
                                        'user',
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return MasonryGridView.builder(
                                    ...
                                    itemCount:
                                        staggeredViewClothRecordList.length,
                                    itemBuilder: (context, staggeredViewIndex) {
                                      final staggeredViewClothRecord =
                                          staggeredViewClothRecordList[
                                              staggeredViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
