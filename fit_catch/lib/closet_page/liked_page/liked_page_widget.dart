...
import 'package:fit_catch/closet_page/liked_detail_page/liked_detail_page_widget.dart';
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => LikedDetailPageWidget(
                                                  coordinationRecord: staggeredViewCoordinationRecord,
                                                ),
                                              ),
                                            );
                                          },
                                          child: Column(
                                            ...
                                            children: [
                                              Container(
                                                height: MediaQuery.sizeOf(context).height * 0.3, // Adjust height as needed
                                                child: Stack(
                                                  children: [
                                                    if (staggeredViewCoordinationRecord.top != null)
                                                      StreamBuilder<ClothRecord>(
