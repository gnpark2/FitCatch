...
import 'cloth_detail_page_model.dart';
export 'cloth_detail_page_model.dart';

class ClothDetailPageWidget extends StatefulWidget {
  const ClothDetailPageWidget({
    super.key,
    required this.clothDetail,
  });

  final DocumentReference? clothDetail;

  @override
  State<ClothDetailPageWidget> createState() => _ClothDetailPageWidgetState();
}

class _ClothDetailPageWidgetState extends State<ClothDetailPageWidget> {
  late ClothDetailPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClothDetailPageModel());
  }
          ...
          child: SingleChildScrollView(
            ...
            children: [
              StreamBuilder<ClothRecord>(
                stream: ClothRecord.getDocument(widget!.clothDetail!),
                builder: (context, snapshot) {
                  ...
                  final stackClothRecord = snapshot.data!;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            await widget!.clothDetail!.delete();

                                            context.pushNamed(
                                              'CategoryPage',
                                              queryParameters: {
                                                'categoryParam': serializeParam(
                                                  stackClothRecord.category,
                                                  ParamType.String,
                                                ),
                                              }.withoutNulls,
                                            );
